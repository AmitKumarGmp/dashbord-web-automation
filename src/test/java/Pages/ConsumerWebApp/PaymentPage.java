...
//		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input[placeholder='Enter your card number']")));
//		creditCard.sendKeys(cardNumber);
//		double cardNum= 4111111111111111;
//		JavascriptExecutor js= (JavascriptExecutor)driver;
//		WebElement cardNum= driver.findElement(By.id("ccnumber"));
//		js.executeScript ("document.getElementById('ccnumber').value=4111111111111111");
...
////		js.executeScript("arguments[0].value = arguments[1]; ", cardNum, inputField);
