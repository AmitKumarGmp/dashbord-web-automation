...
public class SessionUtils {
    ...
    public void startSession(ParkingMapper parkingMapper) throws InterruptedException {
        ...
        System.out.println("Main ActualInitialParkingPrice:" + this.SC.ActualInitialParkingPrice);// Main
                                                                                                  // ActualInitialParkingPrice:1.14
        ...
        Thread.sleep(1000);
        // softAssert.assertEquals(initialparkingprice, 1.14,"Initial parking price
        // fail.");
        // softAssert.assertEquals(initialparkinghours, 0,"Initial parking hours
        // fail.");
        // softAssert.assertEquals(initialparkingminutes, 12,"Initial parking min
        // fail.");

        this.SC.PaymentConfirmation();
        System.out.println("Main ActualPaymentSuccess:" + this.SC.ActualPaymentSuccess);// Main
                                                                                        // ActualPaymentSuccess:Payment
                                                                                        // Successful
        this.softAssert.assertEquals(this.SC.ActualPaymentSuccess, "Payment Successful",
                "Payment Successful message fail");
    ...
    public float extendSession(ParkingMapper parkingMapper) throws InterruptedException {
        ...
        System.out.println("Main ActualExtendedParkingPrice:" + this.SC.ActualExtendedParkingPrice);// Main
                                                                                                    // ActualExtendedParkingPrice:0.00
        ...
        System.out.println("Main ActiveSessionCost:" + this.SC.ActiveSessionCost);// Main ActiveSessionCost:Total :
                                                                                  // €1.14
    ...
    public void stopSession(float finalprice, ParkingMapper parkingMapper) throws InterruptedException {
        ...
        this.softAssert.assertEquals(expiredsessionid, activesessionid,
                "Session ID is not matching in expired sessions.");

        System.out.println("Main ExpiredSessionID:" + this.SC.ExpiredSessionID);// Main ExpiredSessionID:ID: #105899
        System.out.println("Main ExpiredSessionCost:" + this.SC.ExpiredSessionCost);// Main ExpiredSessionCost:Total :
                                                                                    // €1.14
        Thread.sleep(8000);
