...
public class AddPermit {
	...
	public void clickPermit() throws InterruptedException {
		Pages.Dashboard.HomePage ob = PageFactory.initElements(AutomationConfiguration.Driver,
				Pages.Dashboard.HomePage.class);
		ob.gotoPermit();
	}

	@Test(priority = 3)
	public void clickAddpermit() throws InterruptedException {
		Pages.Dashboard.AddPermitPage ap = PageFactory.initElements(AutomationConfiguration.Driver,
				Pages.Dashboard.AddPermitPage.class);
		ap.gotoAddPermit();
	}
