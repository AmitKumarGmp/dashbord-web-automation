...
public class CreateSession {
	...
	public static void readConfigFile(String path) throws IOException {
		...
		AutomationConfiguration.ScreenshotFor = AutomationConfiguration.PropertyFile.getProperty("screenshotfor")
				.toString();
		AutomationConfiguration.LaunchBrowser = AutomationConfiguration.PropertyFile.getProperty("launchbrowser")
				.toString();
		AutomationConfiguration.LaunchMobileApp = AutomationConfiguration.PropertyFile.getProperty("launchmobileapp")
				.toString();
	...
	public synchronized static void launchAndroidDriver() throws MalformedURLException {
		try {
			...
			AutomationConfiguration.DesiredCap.setCapability("deviceName",
					AutomationConfiguration.PropertyFile.getProperty("deviceName").toString());
			AutomationConfiguration.DesiredCap.setCapability("platformName",
					AutomationConfiguration.PropertyFile.getProperty("platformName").toString());
			AutomationConfiguration.DesiredCap.setCapability("appActivity",
					AutomationConfiguration.PropertyFile.getProperty("appActivity").toString());
			AutomationConfiguration.DesiredCap.setCapability("app",
					new File(AutomationConfiguration.PropertyFile.getProperty("app").toString()).getAbsolutePath());
			AutomationConfiguration.DesiredCap.setCapability(MobileCapabilityType.FULL_RESET, true);
			AutomationConfiguration.DesiredCap.setCapability("automationName",
					AutomationConfiguration.PropertyFile.getProperty("automationName").toString());
			AutomationConfiguration.DesiredCap.setCapability("uiautomator2ServerLaunchTimeout", Integer
					.parseInt(AutomationConfiguration.PropertyFile.getProperty("uiautomator2ServerLaunchTimeout")));
			AutomationConfiguration.DesiredCap.setCapability("appWaitDuration",
					Integer.parseInt(AutomationConfiguration.PropertyFile.getProperty("appWaitDuration")));
			AutomationConfiguration.DesiredCap.setCapability("udid",
					AutomationConfiguration.PropertyFile.getProperty("udid").toString());
			...
			AutomationConfiguration.AppiumServerURL = AutomationConfiguration.PropertyFile
					.getProperty("appiumserverurl").toString();
			for (int i = 0; i < 5; i++) {
				try {
					AutomationConfiguration.AppiumDriver = new AndroidDriver<>(
							new URL(AutomationConfiguration.AppiumServerURL), AutomationConfiguration.DesiredCap);
					break;
				} catch (Exception e) {
					AutomationConfiguration.DesiredCap.setCapability("appWaitDuration",
							Integer.parseInt(
									(String) AutomationConfiguration.DesiredCap.getCapability("appWaitDuration"))
									+ 3000);
					Thread.sleep(3000);
				}
			}
	...
	public static void launchWebDriver() {
		try {
			AutomationConfiguration.BrowserName = AutomationConfiguration.PropertyFile.getProperty("browser")
					.toString();
